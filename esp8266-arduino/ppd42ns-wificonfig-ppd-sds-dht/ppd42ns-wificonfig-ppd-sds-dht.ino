...
const unsigned long sending_intervall_ms = 360 * 1000;
...
/*****************************************************************
  ...
  /*****************************************************************/
void start_SDS() {
  debug_out("start_SDS()", DEBUG_MAX_INFO,1);
...
/*****************************************************************
  ...
  /*****************************************************************/
void stop_SDS() {
  debug_out("stop_SDS()", DEBUG_MAX_INFO,1);
...
String sensorSDS() {
  ...
  debug_out("act_milli           : " + String(long(act_milli)), DEBUG_MAX_INFO, 1);
  debug_out("starttime           : " + String(long(starttime)), DEBUG_MAX_INFO, 1);
  debug_out("act_milli-starttime : " + String(long(act_milli - starttime)), DEBUG_MAX_INFO, 1);
  debug_out("sending_intervall_ms: " + String(long(sending_intervall_ms)), DEBUG_MAX_INFO, 1);
  debug_out("warmup_time_SDS_ms  : " + String(long(warmup_time_SDS_ms)), DEBUG_MAX_INFO, 1);
  debug_out("reading_time_SDS_ms : " + String(long(reading_time_SDS_ms)), DEBUG_MAX_INFO, 1);
  debug_out("(long(act_milli-starttime) < (long(sending_intervall_ms) - long(warmup_time_SDS_ms + reading_time_SDS_ms))): " + String((long(act_milli - starttime) < (long(sending_intervall_ms) - long(warmup_time_SDS_ms + reading_time_SDS_ms)))) , DEBUG_MAX_INFO, 1);
  ...
  if (long(act_milli - starttime) < (long(sending_intervall_ms) - long(warmup_time_SDS_ms + reading_time_SDS_ms))) {
    ...
    debug_out("serialSDS.available(): " + String(serialSDS.available()), DEBUG_MAX_INFO, 1);
    while (serialSDS.available() > 0) {
      buffer = serialSDS.read();
...
void setup() {
  ...
  if (sds_read) {
    debug_out("SDS_version_date: " + SDS_version_date(), 0,1);
